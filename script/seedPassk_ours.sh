...
seed_count=16  # 修改这个数字来选择种子数量: 1, 4, 8, 或 16
...
for seed in "${seeds[@]}"; do
    for model_path in "${model_paths[@]}"; do
        for dataset in "${datasets[@]}"; do
            ...
            data_dir=rebuttal/seedPassK/Steering${steering}_numb${steering_number}_coef${steering_coef}_mode${steering_mode_name}/${model_path}/${dataset}/seed${seed}
